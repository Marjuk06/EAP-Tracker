                ...
                if (responseCode in 200..299) {
                    ...
                    try {
                        ...
                        val targetUrlStr = if (baseEndpoint.contains("firebaseio.com")) {
                            if (apiKey.isNotBlank()) "$baseEndpoint/target_exam_config.json?auth=$apiKey" else "$baseEndpoint/target_exam_config.json"
                        } else {
                            "https://eap-tracker-default-rtdb.firebaseio.com/target_exam_config.json"
                        }
