...
export const AdminScreen: React.FC<AdminScreenProps> = ({
 ...
 const [apiKey, setApiKey] = useState<string>(() => {
  return localStorage.getItem('eap_rest_api_key') || 'yleDrwUbDfga8ueOKchQEZ47XCPlrzlRNiCF1NAw';
 });
 ...
 const fetchStudents = async () => {
  ...
  try {
   ...
   const targetUrl = `${baseUrl}/students.json?auth=${apiKey.trim() || 'yleDrwUbDfga8ueOKchQEZ47XCPlrzlRNiCF1NAw'}`;
 ...
 const handlePurgeGhostStudents = () => {
  showCustomConfirm(
   ...
   async () => {
    setIsSyncing(true);
    try {
     const res = await fetch(`https://eap-tracker-default-rtdb.firebaseio.com/students.json?auth=yleDrwUbDfga8ueOKchQEZ47XCPlrzlRNiCF1NAw`);
     if (res.ok) {
      const data = await res.json();
      if (data) {
       let purgedCount = 0;
       for (const [key, val] of Object.entries<any>(data)) {
        ...
        if (isTempKey || isInvalidId) {
         await fetch(`https://eap-tracker-default-rtdb.firebaseio.com/students/${key}.json?auth=yleDrwUbDfga8ueOKchQEZ47XCPlrzlRNiCF1NAw`, {
          method: 'DELETE'
         });
         purgedCount++;
        }
  ...
  showCustomConfirm(
   ...
   async () => {
    ...
    try {
     ...
     await fetch(`https://eap-tracker-default-rtdb.firebaseio.com/students/${studentKey}.json?auth=yleDrwUbDfga8ueOKchQEZ47XCPlrzlRNiCF1NAw`, {
      method: 'DELETE'
     });
     sound.playSuccess();
 ...
 const fetchSentNotifications = async () => {
  try {
   const res = await fetch(`https://eap-tracker-default-rtdb.firebaseio.com/sent_admin_notices.json?auth=yleDrwUbDfga8ueOKchQEZ47XCPlrzlRNiCF1NAw`);
   if (res.ok) {
    const data = await res.json();
    if (data) {
 ...
 const handleDispatchBroadcastNotification = async () => {
  ...
  try {
   ...
   if (broadcastTargetAudience === 'Individual' && broadcastTargetStudentKey) {
    ...
    await fetch(`https://eap-tracker-default-rtdb.firebaseio.com/students/${studentKey}/personal_notice.json?auth=yleDrwUbDfga8ueOKchQEZ47XCPlrzlRNiCF1NAw`, {
     method: 'PUT',
    ...
    await fetch(`https://eap-tracker-default-rtdb.firebaseio.com/global_notifications/latest.json?auth=yleDrwUbDfga8ueOKchQEZ47XCPlrzlRNiCF1NAw`, {
     method: 'PUT',
     headers: { 'Content-Type': 'application/json' },
     body: JSON.stringify(notifPayload)
    });
   ...
   await fetch(`https://eap-tracker-default-rtdb.firebaseio.com/sent_admin_notices.json?auth=yleDrwUbDfga8ueOKchQEZ47XCPlrzlRNiCF1NAw`, {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
    body: JSON.stringify(notifPayload)
   });
  ...
  showCustomConfirm(
   ...
   async () => {
    ...
    try {
     ...
     await fetch(`https://eap-tracker-default-rtdb.firebaseio.com/app_config/latest_update.json?auth=yleDrwUbDfga8ueOKchQEZ47XCPlrzlRNiCF1NAw`, {
      method: 'PUT',
      headers: { 'Content-Type': 'application/json' },
 ...
 const handleDeleteSentNotification = (notifId: string) => {
  showCustomConfirm(
   ...
   async () => {
    setIsSyncing(true);
    try {
     await fetch(`https://eap-tracker-default-rtdb.firebaseio.com/sent_admin_notices/${notifId}.json?auth=yleDrwUbDfga8ueOKchQEZ47XCPlrzlRNiCF1NAw`, {
      method: 'DELETE'
     });
     sound.playSuccess();
   ...
   async () => {
    ...
    try {
     ...
     for (const sid of targetStudentIds) {
      ...
      await fetch(`https://eap-tracker-default-rtdb.firebaseio.com/students/${studentKey}/app_update.json?auth=yleDrwUbDfga8ueOKchQEZ47XCPlrzlRNiCF1NAw`, {
       method: 'PUT',
       headers: { 'Content-Type': 'application/json' },
       body: JSON.stringify(updatePayload)
      });
    ...
    try {
     for (const sid of targetStudentIds) {
      ...
      if (preset.data.subjects && preset.data.subjects.length > 0) {
       await fetch(`https://eap-tracker-default-rtdb.firebaseio.com/students/${studentKey}/custom_syllabus.json?auth=yleDrwUbDfga8ueOKchQEZ47XCPlrzlRNiCF1NAw`, {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
      ...
      if (preset.data.routineDays && preset.data.routineDays.length > 0) {
       ...
       await fetch(`https://eap-tracker-default-rtdb.firebaseio.com/students/${studentKey}/${path}.json?auth=yleDrwUbDfga8ueOKchQEZ47XCPlrzlRNiCF1NAw`, {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
      ...
      if (preset.data.exams && preset.data.exams.length > 0) {
       await fetch(`https://eap-tracker-default-rtdb.firebaseio.com/students/${studentKey}/custom_exams.json?auth=yleDrwUbDfga8ueOKchQEZ47XCPlrzlRNiCF1NAw`, {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
  ...
  showCustomConfirm(
   ...
   async () => {
    ...
    try {
     for (const sid of targetStudentIds) {
      const studentKey = cleanStudentKey(sid);
      await fetch(`https://eap-tracker-default-rtdb.firebaseio.com/students/${studentKey}/custom_syllabus.json?auth=yleDrwUbDfga8ueOKchQEZ47XCPlrzlRNiCF1NAw`, { method: 'DELETE' });
      await fetch(`https://eap-tracker-default-rtdb.firebaseio.com/students/${studentKey}/custom_routine.json?auth=yleDrwUbDfga8ueOKchQEZ47XCPlrzlRNiCF1NAw`, { method: 'DELETE' });
      await fetch(`https://eap-tracker-default-rtdb.firebaseio.com/students/${studentKey}/custom_online_routine.json?auth=yleDrwUbDfga8ueOKchQEZ47XCPlrzlRNiCF1NAw`, { method: 'DELETE' });
      await fetch(`https://eap-tracker-default-rtdb.firebaseio.com/students/${studentKey}/custom_exams.json?auth=yleDrwUbDfga8ueOKchQEZ47XCPlrzlRNiCF1NAw`, { method: 'DELETE' });
     }
     sound.playSuccess();
 ...
 const handleAuditStudentInbox = async (studentId: string) => {
  ...
  try {
   const studentKey = studentId.replace(/[^a-zA-Z0-9]/g, '_');
   const res = await fetch(`https://eap-tracker-default-rtdb.firebaseio.com/students/${studentKey}/personal_notice.json?auth=yleDrwUbDfga8ueOKchQEZ47XCPlrzlRNiCF1NAw`);
   const list: any[] = [];
   if (res.ok) {
   ...
   const globalRes = await fetch(`https://eap-tracker-default-rtdb.firebaseio.com/global_notifications/latest.json?auth=yleDrwUbDfga8ueOKchQEZ47XCPlrzlRNiCF1NAw`);
   if (globalRes.ok) {
 ...
 const handleSaveAutomatedRules = async () => {
  setIsSyncing(true);
  try {
   await fetch(`https://eap-tracker-default-rtdb.firebaseio.com/automated_notification_rules.json?auth=yleDrwUbDfga8ueOKchQEZ47XCPlrzlRNiCF1NAw`, {
    method: 'PUT',
    headers: { 'Content-Type': 'application/json' },
 ...
 const fetchActiveTargetExam = async () => {
  try {
   ...
   const targetUrl = `${baseUrl}/target_exam_config.json?auth=${apiKey.trim() || 'yleDrwUbDfga8ueOKchQEZ47XCPlrzlRNiCF1NAw'}`;
   const res = await fetch(targetUrl);
   if (res.ok) {
    const data = await res.json();
 ...
 const handleOpenStudentDetail = async (student: StudentTelemetry) => {
  ...
  try {
   ...
   const resRoutine = await fetch(`https://eap-tracker-default-rtdb.firebaseio.com/students/${studentKey}/custom_routine.json?auth=yleDrwUbDfga8ueOKchQEZ47XCPlrzlRNiCF1NAw`);
   if (resRoutine.ok) {
   ...
   const resExams = await fetch(`https://eap-tracker-default-rtdb.firebaseio.com/students/${studentKey}/custom_exams.json?auth=yleDrwUbDfga8ueOKchQEZ47XCPlrzlRNiCF1NAw`);
   if (resExams.ok) {
   ...
   const resSyllabus = await fetch(`https://eap-tracker-default-rtdb.firebaseio.com/students/${studentKey}/custom_syllabus.json?auth=yleDrwUbDfga8ueOKchQEZ47XCPlrzlRNiCF1NAw`);
   if (resSyllabus.ok) {
 ...
 const handleResetStudentCustomRoutine = (studentId: string) => {
  showCustomConfirm(
   ...
   async () => {
    ...
    try {
     const studentKey = cleanStudentKey(studentId);
     await fetch(`https://eap-tracker-default-rtdb.firebaseio.com/students/${studentKey}/custom_routine.json?auth=yleDrwUbDfga8ueOKchQEZ47XCPlrzlRNiCF1NAw`, {
      method: 'DELETE'
     });
     setStudentCustomRoutine(null);
     setStudentCustomOnlineRoutine(null);
 ...
 const handleSaveStudentDayEdit = async (
  ...
  try {
   ...
   const res = await fetch(`https://eap-tracker-default-rtdb.firebaseio.com/students/${studentKey}/custom_routine.json?auth=yleDrwUbDfga8ueOKchQEZ47XCPlrzlRNiCF1NAw`, {
    method: 'PATCH',
    headers: { 'Content-Type': 'application/json' },
    body: JSON.stringify(payload)
   });
 ...
 const handleSaveStudentExamDayEdit = async (
  ...
  try {
   ...
   const res = await fetch(`https://eap-tracker-default-rtdb.firebaseio.com/students/${studentKey}/custom_exams.json?auth=yleDrwUbDfga8ueOKchQEZ47XCPlrzlRNiCF1NAw`, {
    method: 'PATCH',
    headers: { 'Content-Type': 'application/json' },
    body: JSON.stringify(payload)
   });
 ...
 const handleApplyUploadedRoutine = async () => {
  ...
  try {
   if (uploadedRoutineTargetMode === 'Individual') {
    ...
    const targetUrl = `${baseUrl}/students/${studentKey}/custom_routine.json?auth=${apiKey.trim() || 'yleDrwUbDfga8ueOKchQEZ47XCPlrzlRNiCF1NAw'}`;
 ...
 const handleSendPersonalNotice = async () => {
  ...
  try {
   ...
   const targetUrl = `${baseUrl}/students/${studentKey}/personal_notice.json?auth=${apiKey.trim() || 'yleDrwUbDfga8ueOKchQEZ47XCPlrzlRNiCF1NAw'}`;
   ...
   try {
    const tokenRes = await fetch(`${baseUrl}/students/${studentKey}/fcm_token.json?auth=${apiKey.trim() || 'yleDrwUbDfga8ueOKchQEZ47XCPlrzlRNiCF1NAw'}`);
    if (tokenRes.ok) {
    ...
    if (!studentFcmToken) {
     const profileTokenRes = await fetch(`${baseUrl}/students/${studentKey}/profile_summary/fcm_token.json?auth=${apiKey.trim() || 'yleDrwUbDfga8ueOKchQEZ47XCPlrzlRNiCF1NAw'}`);
 ...
 const handleSendDirectNotification = async (title?: string, body?: string, category?: string) => {
  ...
  try {
   ...
   const targetUrl = `${baseUrl}/broadcast_notification.json?auth=${apiKey.trim() || 'yleDrwUbDfga8ueOKchQEZ47XCPlrzlRNiCF1NAw'}`;
 ...
 const handleSetDailyQuote = async (quoteText: string, author: string = 'Admission Mentor') => {
  ...
  try {
   ...
   const targetUrl = `${baseUrl}/daily_quote_config.json?auth=${apiKey.trim() || 'yleDrwUbDfga8ueOKchQEZ47XCPlrzlRNiCF1NAw'}`;
                 ...
                 async () => {
                  ...
                  try {
                   if (item.type === 'Personal Mentor Notice') {
                    ...
                    await fetch(`https://eap-tracker-default-rtdb.firebaseio.com/students/${cleanKey}/personal_notice.json?auth=yleDrwUbDfga8ueOKchQEZ47XCPlrzlRNiCF1NAw`, {
                     method: 'DELETE'
                    });
                   } else {
                    await fetch(`https://eap-tracker-default-rtdb.firebaseio.com/global_notifications/latest.json?auth=yleDrwUbDfga8ueOKchQEZ47XCPlrzlRNiCF1NAw`, {
